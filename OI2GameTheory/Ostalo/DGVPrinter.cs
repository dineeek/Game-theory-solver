                ...
                (ColumnWidthSetting.Porportional == ColumnWidth))
            {
                ...
                else
                {
                    ...
                    datasize = g.MeasureString(cell.EditedFormattedValue.ToString(), cellstyle.Font,
                        new SizeF(width+20f, maxPages), format);
                    ...
                    if (printWidth < datasize.Width)
                        ...
                        new SizeF(pageWidth - cellstyle.Padding.Left - cellstyle.Padding.Right + 20f, maxPages),
                        format);
                }
                ...
                if ((ColumnWidthSetting.DataWidth == ColumnWidth) ||
                    (ColumnWidthSetting.Porportional == ColumnWidth))
                    size.Width = datasize.Width + cellstyle.Padding.Left + cellstyle.Padding.Right + 20f; 
            }

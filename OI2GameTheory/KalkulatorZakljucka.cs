...
{
    public class KalkulatorZakljucka
    {
        ...
        public KalkulatorZakljucka(DataTable tablica, SpremanjeUnosa podaci, int dif)
        {
        ...
        public string DohvatiZakljucak()
        {
            ...
            {
                zakljucak += "X" + brojacA + " = " + Math.Round((vjerojatnost * 100), 2) + "%   ";
                brojacA++;
            }
            ...
            {
                zakljucak += "Y" + brojacB + " = " + Math.Round((vjerojatnost * 100), 2) + "%   ";
                brojacB++;
            }
